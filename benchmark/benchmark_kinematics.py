    ...
    for batch_size in BATCH_SIZES:
        ...
        if batch_size == BATCH_SIZES[0]:
            ...
            if not verify_correctness(
                fk, q, bard_frame_id, pin_frame_id, pin_model, pin_data, q_pin
            ):
        ...
        # Benchmark Bard
        print("\nBenchmarking Bard...")
        bard_times = benchmark_bard(fk, q, bard_frame_id, NUM_REPEATS, WARMUP_ITERS)
        ...
        pin_times = benchmark_pinocchio(
            pin_model, pin_data, q_pin, pin_frame_id, NUM_REPEATS, WARMUP_ITERS
        )
