...
def verify_correctness(jac, q, bard_frame_id, pin_frame_id, reference_frame, pin_model, pin_data, q_pin):
    ...
    if reference_frame == "world":
        ...
        J_pin = pin.computeFrameJacobian(pin_model, pin_data, q_pin[0], pin_frame_id, pin.ReferenceFrame.WORLD)
    else:
        # Local frame Jacobian
        J_pin = pin.computeFrameJacobian(pin_model, pin_data, q_pin[0], pin_frame_id, pin.ReferenceFrame.LOCAL)
    ...
    for reference_frame in ["world", "local"]:
        ...
        for batch_size in BATCH_SIZES:
            ...
            if batch_size == BATCH_SIZES[0] and reference_frame == "world":
                ...
                if not verify_correctness(jac, q, bard_frame_id, pin_frame_id, reference_frame, 
            ...
            # Benchmark Bard
            print("\nBenchmarking Bard...")
            bard_times = benchmark_bard(jac, q, bard_frame_id, reference_frame,
